...
insert into orders (id,order_number,username,
                    ...
                    status,comments) values
                                         (1, 'asdf-1234', 'user', 'user', 'user@gmail.com', '123456789', '190 Kingfisher St', 'Room 204B', 'Vancouver', 'BC', 'R3Y0B9', 'Canada', 'NEW', null),
                                         (2, 'asdf-5678', 'johnuser', 'john', 'john@gmail.com', '123456789', '123 John St', '', 'San Francisco', 'CA', '2140033', 'USA', 'NEW', null)
;
